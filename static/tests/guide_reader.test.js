...
test("a section overview is a single clickable expandable heading", () => {
    const roots = navigationTree([page(1, {name: "Business", is_section_overview: true}), page(2, {parent_id: 1})]);
